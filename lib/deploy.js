...
function createMongoDb() {
    ...
    console.log(clc.blueBright("\nstarting operations using parameters of ") + clc.greenBright(deployTo) + clc.blueBright(" object from configuration file\n"));
...
function useSsh2MasterFiles() {
    if (fs.existsSync(__dirname + '/ssh2-master')) {
        console.log(clc.yellowBright("NOTICE:"));
...
//setup configuration object and last check
if (deployTo !== undefined) configuration = configFile[deployTo];
else configuration = configFile[dbOn];
